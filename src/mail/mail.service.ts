...
export class MailService {
    ...
    sendResetPasswordEmail(name: string, email: string) {
        this.sendEmail("Reset password success", email, "reset-password-notifier", [{ key: 'firstName', value: name }, { key: 'email', value: email }])
    }
}